...
the native evaluator before this change. The isolated column uses the new guest
...
| --- | ---: | ---: | ---: |
| Small generated object | 0.354 ms | 0.467 ms | 1.32× |
| Map and count 10,000 JSON objects | 10.705 ms | 18.649 ms | 1.74× |
| Stream 10,000 IDs through `wc -l` | 15.448 ms | 24.703 ms | 1.60× |

The first small invocation took 1.358 ms natively and 9.491 ms with isolation,
